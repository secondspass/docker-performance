...
class usr_info:
    def __init__(self, usrname, init_acc_time):
        self.usrname = usrname
        self.size = 0
        self.init_acc_time = init_acc_time
        
        self.repos_cnt = 0
        self.layers_cnt = 0
        self.lst_acc_time = 0.0
        self.lst_evict_time = 0.0
        self.acc_cnt = 0
        ...
        self.reuse_times = []
        self.positions_arrivetimes = [] # ()
        self.evict_times = []
    
    def update_repos(self, reponame):
        self.repos_cnt = self.repos_cnt + 1
        self.repos.append(reponame)
        
    def update_layers(self, layer_id):
        self.layers_cnt = layers_cnt + 1
        self.layers.append(layer_id)
        
    def predict_next_repos(self):
        return


class repo_info:
    def __init__(self, reponame, usrname, init_acc_time):
        ...
        def update_layers(self, layer_id):
            self.layers_cnt = self.layers_cnt + 1
            self.layers.append(layer_id)
        
        def predict_next_layers(self):
            return
 
        
class layer_info:
    def __init__(self, layer_id, size, reponame, usrname, init_acc_time):
        self.layer_id = layer_id
        self.size = size
        self.init_acc_time = init_acc_time
        
        self.shared_repos_cnt = 0
        self.shared_usrs_cnt = 0
